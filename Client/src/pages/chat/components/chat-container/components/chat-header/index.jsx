...
const ChatHeader = () => {
    ...
    return (
        <div
            className="h-[10vh] border-b-2 border-[#2f303b]
                            ...
                            <Avatar className="h-12 w-32 rounded-full overflow-hidden">
                                {selectedChatData.image ? (
                                    <AvatarImage
                                        ...
                                        alt="profileImage"
                                        className="object-cover w-fulll h-full bg-black"
                                    />
                                ) : (
                                    <div
                                        className={`uppercase h-12 w-32 text-lg border-[1px] flex items-center justify-center rounded-full
